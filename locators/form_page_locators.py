...
class FormPageLocators:
    ...
    GENDER = (By.CSS_SELECTOR, f'div[class*="custom-control"] input[id="gender-radio-{random.randint(1, 4)}"]')
    MOBILE = (By.CSS_SELECTOR, 'input[id="userNumber"]')
    DATE_OF_BIRTH = (By.CSS_SELECTOR, 'input[id="dateOfBirthInput"]')
    SUBJECT = (By.CSS_SELECTOR, 'input[id="subjectInput"]')
    HOBBIES = (By.CSS_SELECTOR, f'div[class*="custom-control"] input[id="hobbies-checkbox-{random.randint(1, 4)}"]')
